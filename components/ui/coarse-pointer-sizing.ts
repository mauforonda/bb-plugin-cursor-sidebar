...
export const COARSE_POINTER_PROMPT_ACTION_BUTTON_CLASS =
  "h-8 px-2 transition-colors max-md:pointer-coarse:h-10 max-md:pointer-coarse:px-2.5";

export const COARSE_POINTER_PROMPT_ICON_ACTION_BUTTON_CLASS =
  "size-auto h-8 px-2 transition-colors max-md:pointer-coarse:h-10 max-md:pointer-coarse:px-2.5";

export const COARSE_POINTER_PROMPT_COMBO_BUTTON_CLASS =
  "h-8 w-8 rounded-l-none border-l border-l-primary-foreground/20 px-0 transition-colors hover:border-l-primary-foreground/30 max-md:pointer-coarse:h-10 max-md:pointer-coarse:w-10";
