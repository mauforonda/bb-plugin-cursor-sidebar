 ...
 * stack. Ordering chooses how conversations and groups are sorted, including
 * the manual order that drag reordering writes. Radix menu primitives supply
 * real arrow-key navigation, roving focus
